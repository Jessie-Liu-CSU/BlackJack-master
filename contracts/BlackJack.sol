...
contract BlackJack {
    ...
    ///*********fallback - Unused***********///
    function () isValidAddr newRound external payable {
    ...
    ///************show the 1st card of players*************///
    function Playercard() public view returns (uint256) {
        return _pCard1;
    }

    ///************show the 1st card of players*************///
    function PlayerBet() public view returns (uint256) {
        return _pBet;
    }
